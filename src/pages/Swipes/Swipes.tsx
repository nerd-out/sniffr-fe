  ...
  return (
    <FullWidthCenteredWrapper>
      <Box sx={{ width: '50%', minWidth: '350px', p: 0 }}>
        <Box component="img" sx={{ width: '100%', borderRadius: '10px', pb: 1 }} src={demoDogImages["Max"]} />
        <Typography variant='h1'>{dog.name}</Typography>
        <Typography variant='subtitle2' sx={{ pb: 1 }}>A {dog.temperament} {dog.breed}</Typography>
        <Typography variant='h6'>Bio:</Typography> 
        <Typography variant='body1' sx={{ pb: 1 }}>{dog.bio}</Typography>
        <Typography variant='h6'>Details:</Typography> 
        <Typography variant='body1'>
        <List dense={false}>
            <ListItem sx={{ pt: 0, pb: 0 }}>
                <ListItemText
                primary={`Size: ${dog.size}`}
                />
            </ListItem>
            <ListItem sx={{ pt: 0, pb: 0 }}>
                <ListItemText
            ...
            <ListItem sx={{ pt: 0, pb: 0 }}>
                <ListItemText
                primary={`Fixed: ${dog.fixed ? "Yes" : "No"}`}
                />
            </ListItem>
            <ListItem sx={{ pt: 0, pb: 0 }}>
                <ListItemText
        ...
        <Box sx={{ width: '100%', mt: 4, mb: 4, display: 'flex', justifyContent: 'space-between' }}>
        <Button startIcon={<ClearIcon />} variant="contained" size="large" color="error">
          Nope
        </Button>
        <Button startIcon={<CheckIcon />} variant="contained" size="large" color="success">
          It&#39;s a Match!
        </Button>
        </Box>
      </Box>
